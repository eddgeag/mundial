...
train_file_v6 <- file.path(data_dir, "training_v6_feature_engineered.csv")
pred_file_v6  <- file.path(data_dir, "fixtures_2026_v6_feature_engineered.csv")
...
cat("\n==============================\n")
cat("V6 FEATURE ENGINEERED CONFIG\n")
cat("==============================\n")
cat("data_dir:", data_dir, "\n")
cat("out_dir:", out_dir, "\n")
cat("cores internos:", N_CORES, "\n")
cat("RF random configs:", N_RF_RANDOM, "\n")
cat("XGB random configs:", N_XGB_RANDOM, "\n")
cat("XGB refine configs:", N_XGB_REFINE, "\n")
